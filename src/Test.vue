...
onMounted(() => {
  ...
  getModelMesh('textures/yellow.png', 'textures/overlay.svg').then((modelMesh) => {
...
async function getModelMesh(texturePath: string, svgPath: string) {
  const textureLoader = new THREE.TextureLoader()
  const stlGeo = new THREE.PlaneGeometry(10, 10, 10, 10)
